...
* `serialize_nano_core`: A Rust program that creates a serialized representation of the symbols in the `nano_core` object file from the output of `demangle_readelf_file`. 
