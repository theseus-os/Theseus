...
ifeq ($(ARCH), aarch64)
	...
	CARGO_BUILD_EXCLUDE += --exclude panic_wrapper
	CARGO_BUILD_EXCLUDE += --exclude mmu_x86
endif
...
ifeq ($(ARCH), x86_64)
	...
	CARGO_BUILD_EXCLUDE += --exclude panic_wrapper_arm
	CARGO_BUILD_EXCLUDE += --exclude mmu_arm
endif