...
#[cfg(rq_eval)]
/// The runqueue evaluation is run on a 72 core server. So we need to increase the initial heap size to be able to create all the per-core heaps.
pub const KERNEL_HEAP_INITIAL_SIZE: usize = 128 * 1024 * 1024; //128 MiB
