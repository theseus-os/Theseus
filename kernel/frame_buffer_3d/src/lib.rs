...
pub fn draw_pixel(x:usize, y:usize, color:u32) {
    FRAME_DRAWER.lock().draw_pixel_3d(x, y, 0, color);
}
...
pub fn draw_line(start_x:usize, start_y:usize, end_x:usize, end_y:usize, color:u32) {
    FRAME_DRAWER.lock().draw_line_3d(start_x as i32, start_y as i32, end_x as i32, end_y as i32, 0, color);
}
...
pub fn draw_rectangle(start_x:usize, start_y:usize, width:usize, height:usize, color:u32) {
    FRAME_DRAWER.lock().draw_rectangle_3d(start_x, start_y, width, height, 0, color)
}
