...
impl<S: RxQueueRegisters, T: RxDescriptor, U: TxQueueRegisters, V: TxDescriptor>
    VirtualNic<S, T, U, V>
{
...
impl<S: RxQueueRegisters, T: RxDescriptor, U: TxQueueRegisters, V: TxDescriptor>
    NetworkInterfaceCard for VirtualNic<S, T, U, V>
{
...
impl<S: RxQueueRegisters, T: RxDescriptor, U: TxQueueRegisters, V: TxDescriptor> Drop
    for VirtualNic<S, T, U, V>
{
