...
pub const REG_RDTR:                 u32 = 0x2820;      // RX Delay Timer Register
pub const REG_RXDCTL:               u32 = 0x3828;      // RX Descriptor Control
pub const REG_RADV:                 u32 = 0x282C;      // RX Int. Absolute Delay Timer
pub const REG_RSRPD:                u32 = 0x2C00;      // RX Small Packet Detect Interrupt
 
pub const REG_MTA:                  u32 = 0x5200; 
pub const REG_CRCERRS:              u32 = 0x4000;

pub const REG_TIPG:                 u32 = 0x0410;      // Transmit Inter Packet Gap
pub const ECTRL_SLU:                u32 = 0x40;        // set link up
