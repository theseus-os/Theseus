...
extern crate kernel_config; // our configuration options, just a set of const definitions. // decoupled, fault-tolerant queue
...
pub fn init(
    ...
    info!(
        "Finished handling and booting up all {} AP cores.",
        ap_count
    );
