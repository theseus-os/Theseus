...
pub fn test_nic_driver_e1000e(_: Option<u64>) {
    debug!("TESTING e1000e NIC DRIVER!!");
    dhcp_request_packet_e1000e();
}
...
pub fn dhcp_request_packet_e1000e(){
    ...
    let packet:[u8;314] = [0xff,0xff,0xff,0xff,0xff,0xff,0x00,0x1f,0xc6,0x9c,0x89,0x4c,0x08,0x00,0x45,0x00,
        ...
        let length: u16 = 314;
        let _result = e1000e_nc.send_packet(addr, length);
}