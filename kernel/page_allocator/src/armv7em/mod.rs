...
static DESIGNATED_PAGES_HIGH_START: Page = Page::containing_address(VirtualAddress::new_canonical(0x2002_0000));

const MIN_PAGE: Page = Page::containing_address(VirtualAddress::new_canonical(0x2001_0000));
