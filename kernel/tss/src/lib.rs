...
pub fn tss_set_rsp0(new_privilege_stack_top: VirtualAddress) -> Result<(), &'static str> {
    ...
    let mut tss_entry = TSS
        ...
        .lock();
    tss_entry.privilege_stack_table[0] =
        x86_64::VirtAddr::new(new_privilege_stack_top.value() as u64);
...
pub fn create_tss(
    ...
    tss.privilege_stack_table[0] =
        x86_64::VirtAddr::new(privilege_stack_top_unusable.value() as u64);
    tss.interrupt_stack_table[DOUBLE_FAULT_IST_INDEX] =
        x86_64::VirtAddr::new(double_fault_stack_top_unusable.value() as u64);
