...
impl EntryFlags {
    ...
    pub const fn into_huge(&self) -> EntryFlags {
        EntryFlags::from_bits_truncate(self.bits() | EntryFlags::HUGE_PAGE.bits())
    }
    ...
    pub const fn into_writable(&self) -> EntryFlags {
        EntryFlags::from_bits_truncate(self.bits() | EntryFlags::WRITABLE.bits())
    }
    ...
    pub const fn into_non_exclusive(&self) -> EntryFlags {
        ...
        EntryFlags::from_bits_truncate(self.bits() & !EntryFlags::EXCLUSIVE.bits())
    }
