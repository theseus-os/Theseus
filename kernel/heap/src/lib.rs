...
/// When a more complex heap is initialized it is set as the default allocator by calling `set_allocator_functions`.
pub struct Heap {
...
/// 
/// # Warning
/// This function should only be used by an allocator in conjunction with `deallocate_large_object`
pub unsafe fn allocate_large_object(layout: Layout) -> Result<NonNull<u8>, &'static str> {
...
/// 
/// # Warning
/// This function should only be used by an allocator in conjunction with `allocate_large_object` 
pub unsafe fn deallocate_large_object(ptr: *mut u8, layout: Layout) {
