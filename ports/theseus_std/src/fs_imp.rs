...
//! from the [library/sys/unsupported/fs.rs] file, which contains the skeleton of all 
...
//! [library/sys/unsupported/fs.rs](https://github.com/rust-lang/rust/blob/master/library/std/src/sys/unsupported/fs.rs)
